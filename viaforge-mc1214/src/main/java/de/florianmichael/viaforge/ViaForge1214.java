...
@Mod("viaforge")
public class ViaForge1214 implements VFPlatform {

    public ViaForge1214(final FMLJavaModLoadingContext context) {
        context.getModEventBus().addListener(this::onInit);
    }
    ...
    public ServerboundPacketType getCustomPayloadPacketType() {
        return ServerboundPackets1_21_4.CUSTOM_PAYLOAD;
    }
